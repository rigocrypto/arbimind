...
export function PromotionBanner() {
  ...
  return (
    <div className="mt-16 w-full bg-gradient-to-r from-purple-600 via-pink-500 to-cyan-500 text-white py-2 px-4 flex items-center justify-center text-sm font-semibold shadow-lg z-30 relative">
      <span>
